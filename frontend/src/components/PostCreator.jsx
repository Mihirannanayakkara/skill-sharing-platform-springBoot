...
const EventPostForm = ({ eventPost, setEventPost, onSubmit }) => {
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            <div>
                ...
                <input
                    ...
                    onChange={(e) => setEventPost({...eventPost, title: e.target.value})}
                    required
                />
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    value={eventPost.description}
                    onChange={(e) => setEventPost({...eventPost, description: e.target.value})}
                    required
                />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setEventPost({...eventPost, date: e.target.value})}
                        required
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setEventPost({...eventPost, time: e.target.value})}
                        required
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) => setEventPost({...eventPost, location: e.target.value})}
                />
            </div>
            ...
            <div className="flex items-center">
                <input
                    ...
                    checked={eventPost.virtual}
                    onChange={(e) => setEventPost({...eventPost, virtual: e.target.checked})}
                />
            ...
            {/* Event image upload could be added here */}

            <div className="flex justify-end pt-4">
                <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition disabled:bg-red-300"
                    onClick={onSubmit}
                    disabled={!eventPost.title || !eventPost.date || !eventPost.time}
                >
                    Create Event
                </motion.button>
            </div>
